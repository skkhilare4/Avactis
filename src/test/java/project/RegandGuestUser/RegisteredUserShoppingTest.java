...
import jxl.Sheet;
import jxl.Workbook;
import project.AdminTest.AdminPO;
...
public class RegisteredUserShoppingTest {
	RegisteredUserShoppingPO regshop;
	SignInPO signpo;
	CheckoutPO checkoutobj;
		
  @Test(dataProvider = "NTLoginData")
  public void RegisteredUserShopping(String ep1,String ep2,String ep3,String epr1,String epr2,String epr3) {
	
	  signpo=regshop.RegisteredUserShopping(ep1, ep2, ep3);
	  checkoutobj=signpo.SignIn();
